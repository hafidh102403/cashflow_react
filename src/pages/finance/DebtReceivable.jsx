...
/* =========================================================
   DATA AWAL
   DIKOSONGKAN AGAR SEMUA DIMULAI DARI 0
========================================================= */
...
function DebtReceivable() {
  ...
  const totalPaid = useMemo(() => {
    return data.reduce(
      (total, item) => total + Number(item.paid || 0),
      0
    );
  }, [data]);
  ...
  function handleSubmit(event) {
    ...
    if (
      ...
      alert("Silakan lengkapi data utang/piutang.");
      return;
    }
    ...
    ===================================================== */
      ...
      setData((previous) => [newData, ...previous]);
    }
      ...
      <div className="transaction-summary-grid debt-summary-grid">
        ...
        <div className="transaction-summary-card">
          ...
          <div>
            ...
            <strong>
              {formatRupiah(remainingReceivable)}
            </strong>
          </div>
        </div>
      </div>
